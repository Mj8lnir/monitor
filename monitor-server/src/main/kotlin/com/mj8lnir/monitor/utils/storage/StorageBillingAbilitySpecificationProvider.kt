...
@Component
class StorageBillingAbilitySpecificationProvider : SpecificationProvider<Storage> {
    ...
    override fun getSpec(input: String): Specification<Storage> {
        ...
        return Specification { root: Root<Storage>, _: CriteriaQuery<*>?, builder: CriteriaBuilder ->
            builder.equal(root.get<Boolean>(StorageColumn.BILLING_ABILITY.fieldName), bool)
        }
    }
}